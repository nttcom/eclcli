...
class CreateRecordSet(command.Lister):
    ...
    def take_action(self, parsed_args):
        ...
        recordset = dns_client.create_recordset(*args)
...
class DeleteMultipleRecordSets(command.Command):
    ...
    def take_action(self, parsed_args):
        dns_client = self.app.eclsdk.conn.dns
        dns_client.delete_recordsets(parsed_args.zone_id, parsed_args.recordset_ids)
...
class UpdateRecordSet(command.ShowOne):
    ...
    def take_action(self, parsed_args):
        ...
        recordset = dns_client.update_recordset(*args)
